...
<head>
    ...
    <link href="editar_tags_styles.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-body text-center">
                ...
                <h3 class="m0 text-bold">Etiqueta</h3>
                <div class="mv-lg">
                    <p>DESCRIPCION ASDFJHKSFHJKLSADHKFLHJASDHFJ</p>
                </div>
                <div class="text-center"><a class="btn btn-primary" href="">Volver</a></div>
            </div>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="row pv-lg">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="text-right"><a class="text-muted" href="#">Borrar</a></div>
                    </div>
                </div>
            </div>
        </div>
