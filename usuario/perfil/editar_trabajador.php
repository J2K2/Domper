<?php
  ...
  if (isset($_SESSION['idtbl_user'])) {
    ...
    if (isset($_POST['editar'])) {
      ...
      $sql_actualizar = "UPDATE tbl_trabajador SET
      nombre='$newnombres', 
      ...
      $consulta_actualizar->bindparam(':id',$trabajador['idtbl_trabajador']);
                  ...
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <hr>
                            ...
                            <div class="row">
                            <div class="edit">
                            <h6>Ciudades en las que labora</h6>
                            </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    <input class="form-control" type="text" name="newnombres" value="<?php echo $trabajador['nombre'];?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input class="form-control" type="text" name="newapellidos" value="<?php echo $trabajador['apellido'];?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input class="form-control" type="number" name="newtel_fijo" value="<?php echo $trabajador['tel_fijo'];?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input class="form-control" type="number" name="newtel_celular" value="<?php echo $trabajador['tel_celular'];?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input class="form-control" type="text" name="newcorreo" value="<?php echo $trabajador['correo'];?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
