                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <a href="editar/editar_empresa.php"><button class="btn btn-outline-primary">Editar</button></a>
                    </div>
                  </div>
                </div>
              </div>
