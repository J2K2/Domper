                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <a href="../../interaccion/cat_product.php?id=<?php echo $trabajador['idtbl_trabajador']?>"><button class="btn btn-outline-primary">Productos</button></a>
                      <a href="../../interaccion/cat_service.php?id=<?php echo $trabajador['idtbl_trabajador']?>"><button class="btn btn-outline-primary">Servicios</button></a>
                    </div>
                  </div>
                </div>
              </div>
